...
import { TIP_MAILTO } from "@/lib/site";
...
export default async function PostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="mt-14 p-5 rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] text-sm">
        <p className="text-[var(--fg-muted)]">
          Found this useful?{" "}
          <a href={TIP_MAILTO} className="text-[var(--accent)] font-medium hover:underline">
            Suggest the next topic
          </a>{" "}
          or{" "}
          <Link href="/support/" className="text-[var(--accent)] font-medium hover:underline">
            support the work
          </Link>
          .
        </p>
